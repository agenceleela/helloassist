        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/80 mb-6 max-w-md">
              ...
              Services de secrétariat pour TPE, indépendants et associations.
            </p>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#d63384] transition-colors duration-300"
              ...
              <a
                href="https://www.tiktok.com/@helloassist97"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#d63384] transition-colors duration-300"
                aria-label="TikTok"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#accueil" className="text-white/80 hover:text-[#d63384] transition-colors">
                  Accueil
                </a>
              </li>
              <li>
                <a href="#services" className="text-white/80 hover:text-[#d63384] transition-colors">
                  Services
                </a>
              </li>
              <li>
                <a href="#about" className="text-white/80 hover:text-[#d63384] transition-colors">
                  À propos
                </a>
              </li>
              <li>
                <a href="#blog" className="text-white/80 hover:text-[#d63384] transition-colors">
                  Actualités
                </a>
              </li>
              <li>
                <a href="#contact" className="text-white/80 hover:text-[#d63384] transition-colors">
                  Contact
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/80">
              <li>
                <a href="mailto:contact@helloassist.fr" className="hover:text-[#d63384] transition-colors">
                  contact@helloassist.fr
                </a>
              </li>
              <li>
                <a href="tel:+590690466713" className="hover:text-[#d63384] transition-colors">
                  +590 690 46 67 13
                </a>
              </li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-white/60 text-sm">
              © {currentYear} Hello Assist. Tous droits réservés.
            </p>
            <div className="flex gap-6 text-sm">
              <a
                href="/mentions-legales"
                className="text-white/60 hover:text-[#d63384] transition-colors"
              >
                Mentions légales
              </a>
              <a
