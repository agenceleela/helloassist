...
const ComingSoon = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex flex-col bg-[#fffefe]">
      ...
      {/* ===== Contenu ===== */}
      <div className="relative z-10 flex flex-col flex-1 px-6 md:px-12 pt-8 pb-10 max-w-5xl mx-auto w-full">
        {/* Logo à gauche + bannière à droite (positions maquette) */}
        ...
        {/* Slogan aligné à gauche (position maquette) */}
        <div className="mb-12 md:mb-16">
          <p className="text-4xl md:text-6xl font-bold text-[#1a3a5c] leading-tight">
            Passez
            <br />
            la main...
          </p>
          <p className="script-accent text-5xl md:text-7xl leading-tight">et c'est fait !</p>
          <svg
            className="mt-3 w-40 md:w-56 text-[#f3c3d4]"
            viewBox="0 0 220 14"
            fill="none"
            stroke="currentColor"
            strokeWidth="5"
        ...
        <div className="text-center max-w-2xl mx-auto w-full flex-1 flex flex-col justify-center">
          <h1 className="text-3xl md:text-5xl font-bold text-[#1a3a5c] leading-tight mb-4 inline-flex items-center justify-center gap-3">
            Site internet
            <br className="md:hidden" />
            <span className="hidden md:inline">&nbsp;</span>
            bientôt disponible
            <Sparkles className="text-[#e58bab] flex-shrink-0" size={32} fill="currentColor" />
          </h1>
          ...
          {/* Formulaire (disposition maquette avec icône enveloppe) */}
          ...
          <p className="text-sm text-gray-500 mb-6">@helloassist971</p>
