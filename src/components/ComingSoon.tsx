...
const ComingSoon = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden flex flex-col bg-[#fffefe]">
      {/* ===== Patterns du fond (fidèles à la maquette) ===== */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        {/* Zone rose en haut avec bord inférieur courbé */}
        ...
        {/* Branches de feuilles bleues à droite */}
        <svg
      ...
      <div className="relative z-10 flex flex-col flex-1 px-6 md:px-12 pt-6 pb-6 max-w-5xl mx-auto w-full">
        {/* Logo à gauche + bannière à droite */}
        <div className="flex items-start justify-between gap-4 mb-6">
          ...
          />
          <span className="inline-flex items-center gap-2 bg-[#d9e7f8] text-[#1a3a5c] px-4 py-2 rounded-full text-sm font-medium shadow-sm whitespace-nowrap mt-2">
            <Bell size={16} className="text-[#d63384]" fill="currentColor" />
            Ouverture prochaine
          </span>
        </div>
        ...
        <div className="text-center max-w-2xl mx-auto w-full flex-1 flex flex-col justify-center">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-[#1a3a5c] leading-tight mb-3">
            Site internet
            <br />
            bientôt disponible
            <Sparkles
          ...
          <p className="text-gray-600 text-base md:text-lg mb-6 max-w-xl mx-auto">
          ...
          {/* Formulaire (icône enveloppe + bouton rond) */}
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg p-5 md:p-7 mb-6 text-left">
            {subscribed ? (
              ...
              <>
                <div className="flex items-center gap-4 mb-4">
                  <div className="relative flex-shrink-0">
                    <Mail className="text-[#1a3a5c]" size={28} strokeWidth={1.8} />
                    <Sparkles
                  ...
                  <p className="font-bold text-[#1a3a5c] text-base md:text-lg leading-snug">
                ...
                <form onSubmit={handleSubmit} className="flex items-center gap-3">
                  <input
                    ...
                    placeholder="E-mail"
                    className="flex-1 px-5 py-3 rounded-full border border-gray-300 bg-white focus:border-[#d63384] focus:ring-2 focus:ring-[#d63384]/20 outline-none transition-all"
                  />
                  <button
                    type="submit"
                    aria-label="S'inscrire"
                    className="w-11 h-11 flex-shrink-0 rounded-full bg-[#d63384] text-white flex items-center justify-center hover:bg-[#1a3a5c] transition-colors duration-300 shadow-md"
                  >
                    <ArrowRight size={18} />
                  </button>
                </form>
          ...
          {/* Réseaux sociaux avec lignes latérales */}
          <div className="flex items-center gap-4 mb-2 max-w-md mx-auto w-full">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-10 h-10 bg-white shadow-md rounded-full flex items-center justify-center text-[#1a3a5c] hover:bg-[#d63384] hover:text-white transition-colors duration-300"
              >
          ...
          <p className="text-sm text-gray-500 mb-3">@helloassist971</p>
